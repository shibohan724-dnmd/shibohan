...
export const translations = {
  zh: {
    ...
    footer: {
      ...
      send: '发送',
      submitSuccess: '已收到你的邮箱，我会尽快联系你。',
      submitError: '发送失败，请稍后重试，或直接',
      submitErrorMail: '发邮件给我',
  ...
  en: {
    ...
    footer: {
      ...
      send: 'Send',
      submitSuccess: 'Got your email—I’ll get back to you soon.',
      submitError: 'Couldn’t send. Try again or',
      submitErrorMail: 'email me directly',
